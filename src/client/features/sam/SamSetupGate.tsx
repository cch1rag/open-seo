          ...
          <div className="max-w-3xl space-y-1.5">
            ...
            <div className="text-sm text-base-content/68">
              {isOpenRouter ? (
                ...
                <>
                  SAM, OpenSEO's in-app AI agent, needs a valid AI provider
                  configuration. Set the missing <code>AI_*</code> values in
                  your <code>.env</code>, restart OpenSEO, then confirm here.
                </>
              )}
            </div>
            {isOpenRouter ? (
